...
npx skills add mkdev-ai/scanrepo.dev -g -y

# specific agents only (OpenCode, Claude Code)
npx skills add mkdev-ai/scanrepo.dev -g -a opencode -a claude-code -y

# just the scanrepo skill from this collection
npx skills add mkdev-ai/scanrepo.dev --skill scanrepo -y

# inspect before installing
npx skills add mkdev-ai/scanrepo.dev --list
```
